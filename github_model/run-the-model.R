...
# breakdown
source("break_down.R")
df1=cea_bd_uc(tp_pre_uc)
df2=rbind(df1,cea_bd_ls(tp_pre_ls))
df3=rbind(df2,cea_bd_sex(tp_pre_Sex))
df4=rbind(df3,cea_bd_rex(tp_pre_Rex))
df5=rbind(df4,cea_bd_di(tp_pre_di))
...
write.csv(df5,"break_down.csv",row.names = FALSE)
