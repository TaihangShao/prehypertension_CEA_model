...
cea_bd_uc<-function(tp_pre_uc){
  ...
  res_uc_bd[1,2:17]=0
  for(i in 1:55){
    res_uc_bd$c_prehypertension[i+1]=res_uc$prehypertension[i+1]*c_uc_p
    res_uc_bd$c_hypertension[i+1]=res_uc$hypertension[i+1]*(c_uc_h+c_drug)
    res_uc_bd$c_stroke[i+1]=res_uc$stroke[i+1]*c_s
    res_uc_bd$c_MI[i+1]=res_uc$MI[i+1]*c_m
    res_uc_bd$c_HF[i+1]=res_uc$HF[i+1]*c_hf
    res_uc_bd$c_post_stroke[i+1]=res_uc$post_stroke[i+1]*c_ps
    res_uc_bd$c_post_MI[i+1]=res_uc$post_MI[i+1]*c_pm
    res_uc_bd$c_post_HF[i+1]=res_uc$post_HF[i+1]*c_phf
    res_uc_bd$c_death[i+1]=(res_uc$death[i+1]-res_uc$death[i])*c_eof
    res_uc_bd$q_prehypertension[i+1]=res_uc$prehypertension[i+1]*u_ph
    res_uc_bd$q_hypertension[i+1]=res_uc$hypertension[i+1]*u_h
    res_uc_bd$q_stroke[i+1]=res_uc$stroke[i+1]*u_s
    res_uc_bd$q_MI[i+1]=res_uc$MI[i+1]*u_m
    res_uc_bd$q_HF[i+1]=res_uc$HF[i+1]*u_hf
    res_uc_bd$q_post_stroke[i+1]=res_uc$post_stroke[i+1]*u_ps
    res_uc_bd$q_post_MI[i+1]=res_uc$post_MI[i+1]*u_pm
    res_uc_bd$q_post_HF[i+1]=res_uc$post_HF[i+1]*u_phf
...
cea_bd_ls<-function(tp_pre_ls){
  ...
  res_ls_bd[1,2:17]=0
  for(i in 1:55){
    res_ls_bd$c_prehypertension[i+1]=res_ls$prehypertension[i+1]*c_ls_p
    res_ls_bd$c_hypertension[i+1]=res_ls$hypertension[i+1]*(c_ls_h+c_drug)
    res_ls_bd$c_stroke[i+1]=res_ls$stroke[i+1]*c_s
    res_ls_bd$c_MI[i+1]=res_ls$MI[i+1]*c_m
    res_ls_bd$c_HF[i+1]=res_ls$HF[i+1]*c_hf
    res_ls_bd$c_post_stroke[i+1]=res_ls$post_stroke[i+1]*c_ps
    res_ls_bd$c_post_MI[i+1]=res_ls$post_MI[i+1]*c_pm
    res_ls_bd$c_post_HF[i+1]=res_ls$post_HF[i+1]*c_phf
    res_ls_bd$c_death[i+1]=(res_ls$death[i+1]-res_ls$death[i])*c_eof
    res_ls_bd$q_prehypertension[i+1]=res_ls$prehypertension[i+1]*u_ph
    res_ls_bd$q_hypertension[i+1]=res_ls$hypertension[i+1]*u_h
    res_ls_bd$q_stroke[i+1]=res_ls$stroke[i+1]*u_s
    res_ls_bd$q_MI[i+1]=res_ls$MI[i+1]*u_m
    res_ls_bd$q_HF[i+1]=res_ls$HF[i+1]*u_hf
    res_ls_bd$q_post_stroke[i+1]=res_ls$post_stroke[i+1]*u_ps
    res_ls_bd$q_post_MI[i+1]=res_ls$post_MI[i+1]*u_pm
    res_ls_bd$q_post_HF[i+1]=res_ls$post_HF[i+1]*u_phf
...
cea_bd_sex<-function(tp_pre_sex){
  ...
  res_sex_bd[1,2:17]=0
  for(i in 1:55){
    res_sex_bd$c_prehypertension[i+1]=res_sex$prehypertension[i+1]*c_sex_p
    res_sex_bd$c_hypertension[i+1]=res_sex$hypertension[i+1]*(c_sex_h+c_drug)
    res_sex_bd$c_stroke[i+1]=res_sex$stroke[i+1]*c_s
    res_sex_bd$c_MI[i+1]=res_sex$MI[i+1]*c_m
    res_sex_bd$c_HF[i+1]=res_sex$HF[i+1]*c_hf
    res_sex_bd$c_post_stroke[i+1]=res_sex$post_stroke[i+1]*c_ps
    res_sex_bd$c_post_MI[i+1]=res_sex$post_MI[i+1]*c_pm
    res_sex_bd$c_post_HF[i+1]=res_sex$post_HF[i+1]*c_phf
    res_sex_bd$c_death[i+1]=(res_sex$death[i+1]-res_sex$death[i])*c_eof
    res_sex_bd$q_prehypertension[i+1]=res_sex$prehypertension[i+1]*u_ph
    res_sex_bd$q_hypertension[i+1]=res_sex$hypertension[i+1]*u_h
    res_sex_bd$q_stroke[i+1]=res_sex$stroke[i+1]*u_s
    res_sex_bd$q_MI[i+1]=res_sex$MI[i+1]*u_m
    res_sex_bd$q_HF[i+1]=res_sex$HF[i+1]*u_hf
    res_sex_bd$q_post_stroke[i+1]=res_sex$post_stroke[i+1]*u_ps
    res_sex_bd$q_post_MI[i+1]=res_sex$post_MI[i+1]*u_pm
    res_sex_bd$q_post_HF[i+1]=res_sex$post_HF[i+1]*u_phf
...
cea_bd_rex<-function(tp_pre_rex){
  ...
  res_rex_bd[1,2:17]=0
  for(i in 1:55){
    res_rex_bd$c_prehypertension[i+1]=res_rex$prehypertension[i+1]*c_rex_p
    res_rex_bd$c_hypertension[i+1]=res_rex$hypertension[i+1]*(c_rex_h+c_drug)
    res_rex_bd$c_stroke[i+1]=res_rex$stroke[i+1]*c_s
    res_rex_bd$c_MI[i+1]=res_rex$MI[i+1]*c_m
    res_rex_bd$c_HF[i+1]=res_rex$HF[i+1]*c_hf
    res_rex_bd$c_post_stroke[i+1]=res_rex$post_stroke[i+1]*c_ps
    res_rex_bd$c_post_MI[i+1]=res_rex$post_MI[i+1]*c_pm
    res_rex_bd$c_post_HF[i+1]=res_rex$post_HF[i+1]*c_phf
    res_rex_bd$c_death[i+1]=(res_rex$death[i+1]-res_rex$death[i])*c_eof
    res_rex_bd$q_prehypertension[i+1]=res_rex$prehypertension[i+1]*u_ph
    res_rex_bd$q_hypertension[i+1]=res_rex$hypertension[i+1]*u_h
    res_rex_bd$q_stroke[i+1]=res_rex$stroke[i+1]*u_s
    res_rex_bd$q_MI[i+1]=res_rex$MI[i+1]*u_m
    res_rex_bd$q_HF[i+1]=res_rex$HF[i+1]*u_hf
    res_rex_bd$q_post_stroke[i+1]=res_rex$post_stroke[i+1]*u_ps
    res_rex_bd$q_post_MI[i+1]=res_rex$post_MI[i+1]*u_pm
    res_rex_bd$q_post_HF[i+1]=res_rex$post_HF[i+1]*u_phf
...
cea_bd_di<-function(tp_pre_di){
  ...
  res_di_bd[1,2:17]=0
  for(i in 1:55){
    res_di_bd$c_prehypertension[i+1]=res_di$prehypertension[i+1]*c_di_p
    res_di_bd$c_hypertension[i+1]=res_di$hypertension[i+1]*(c_di_h+c_drug)
    res_di_bd$c_stroke[i+1]=res_di$stroke[i+1]*c_s
    res_di_bd$c_MI[i+1]=res_di$MI[i+1]*c_m
    res_di_bd$c_HF[i+1]=res_di$HF[i+1]*c_hf
    res_di_bd$c_post_stroke[i+1]=res_di$post_stroke[i+1]*c_ps
    res_di_bd$c_post_MI[i+1]=res_di$post_MI[i+1]*c_pm
    res_di_bd$c_post_HF[i+1]=res_di$post_HF[i+1]*c_phf
    res_di_bd$c_death[i+1]=(res_di$death[i+1]-res_di$death[i])*c_eof
    res_di_bd$q_prehypertension[i+1]=res_di$prehypertension[i+1]*u_ph
    res_di_bd$q_hypertension[i+1]=res_di$hypertension[i+1]*u_h
    res_di_bd$q_stroke[i+1]=res_di$stroke[i+1]*u_s
    res_di_bd$q_MI[i+1]=res_di$MI[i+1]*u_m
    res_di_bd$q_HF[i+1]=res_di$HF[i+1]*u_hf
    res_di_bd$q_post_stroke[i+1]=res_di$post_stroke[i+1]*u_ps
    res_di_bd$q_post_MI[i+1]=res_di$post_MI[i+1]*u_pm
    res_di_bd$q_post_HF[i+1]=res_di$post_HF[i+1]*u_phf
